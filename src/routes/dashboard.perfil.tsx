...
import { FormSection, Field, FieldRow, SettingRow } from "@/components/app/FormSection";
...
function PerfilPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Perfil"
        description="Os seus dados pessoais e preferências de conta."
        Icon={UserRound}
        crumbs={[{ label: "Espaço de trabalho" }, { label: "Perfil" }]}
        actions={<Button size="sm" className="h-9"><Save className="h-4 w-4" /> Guardar alterações</Button>}
      />

      <div className="rounded-md border border-border/70 bg-card px-5">
        <FormSection title="Identidade" description="Como aparece para a sua equipa e nos documentos enviados.">
        ...
        <FormSection title="Preferências" description="Idioma, fuso horário e formato de apresentação.">
          <FieldRow>
        ...
        <FormSection title="Segurança" description="Proteja o acesso à sua conta e reveja sessões activas.">
          <FieldRow>
